...
const HomePageContent = ({ t, lang, services, currentTestimonials }) => {
  ...
  return (
    <>
      ...
      <section id="beratungsformate" className="py-24 relative bg-background overflow-hidden">
        <div className="relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <span className="inline-flex px-4 py-1.5 text-sm font-medium bg-accent text-white rounded-full shadow-md">
                ...
                <ul className="space-y-6">
                  ...
                  <li className="flex items-start">
                    ...
                    <div className="ml-3">
                      ...
                      <a href="tel:+4915755842279" className="text-text/70 hover:text-accent transition-colors">
                       +49 1575 5842279
                      </a>
                    </div>
                  </li>
            ...
            <div className="lg:col-span-2 grid gap-8 sm:grid-cols-2">
              ...
              <div className="space-y-4">
                ...
                <ul className="space-y-2 text-sm text-secondary">
                  ...
                  <li>52070 Aachen</li>
                  <li>
                    <a href="tel:+4915755842279" className="hover:text-primary transition-colors">
                      +49 1575 5842279
                    </a>
                  </li>
                  <li>
